...
[![CI](https://github.com/CammyStory/ovoclaw-connect/actions/workflows/ci.yml/badge.svg)](https://github.com/CammyStory/ovoclaw-connect/actions/workflows/ci.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](./LICENSE)
[![Node](https://img.shields.io/badge/node-%E2%89%A518-brightgreen.svg)](#requirements)
[![Version](https://img.shields.io/badge/version-1.0.0-blue.svg)](https://github.com/CammyStory/ovoclaw-connect/releases)
...
```bash
git clone https://github.com/CammyStory/ovoclaw-connect \
...
```bash
git clone https://github.com/CammyStory/ovoclaw-connect.git
cd ovoclaw-connect
npm install
npm run build
